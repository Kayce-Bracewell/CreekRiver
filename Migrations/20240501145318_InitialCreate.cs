    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "dotdot@dot.net", "Josef", "Yughisvli" },
                    { 2, "Sdenny@gmail.com", "Sandy", "Denny" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.nationalgeographic.com%2Fadventure%2Farticle%2Fhow-to-pick-best-campsite&psig=AOvVaw1yzHgHLNPSJULUtOLIFvPW&ust=1714659448591000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCJiala7S7IUDFQAAAAAdAAAAABAE", "Funky Eagle" },
                    { 3, 3, "https://www.gearo.com/wp-content/uploads/2018/09/campsite_concierge1.png", "Yao Gaui Ridge" },
                    { 4, 4, "https://www.winfieldsoutdoors.co.uk/blog/wp-content/uploads/2015/12/campingtrips.jpg", "Kagouti" },
                    { 5, 1, "https://i.pinimg.com/736x/49/62/af/4962aff65912aa017a4be27652583cde.jpg", "Yeoman" },
                    { 6, 2, "https://do.lolwot.com/wp-content/uploads/2015/08/20-of-the-funniest-camping-photos-of-all-time-20.jpg", "Stone River" }
                });
